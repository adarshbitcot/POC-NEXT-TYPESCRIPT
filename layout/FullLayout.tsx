...
function FullLayout({ children }: { children: ReactNode }) {
    ...
    <Fragment>
      <div className="topbar-wrapper">
        <div className="account-wrapper">
          <Link href={"/"} className="account-logo-wrapper">
            <Image
      ...
      <div className="page-wrapper">
        <aside
          className={`sidebar-wrapper ${
            open ? "open" : ""
          } custom-scrollbar wow fadeInLeft ${open ? "open" : ""}`}
        >
            ...
            <ul className="sidebar-list">
              ...
              >
                ...
                <ul>
                  ...
                  <li>
                    <Link href="/addproduct" className="sidebar-link active">
                      Add Product
                    </Link>
                  </li>
                </ul>
